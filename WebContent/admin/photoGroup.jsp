...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    ...
    <title>black&white用户管理中心——相册分类</title>
		...
		<div id="MainBody">
			...
			<td>
				...
				<td align="left" width="400px">
					<span style="font-size:24px; font-family:'微软雅黑'; margin-left:45px;"><img src="../images/camera.jpg" style="margin-bottom:-5px;" />&nbsp;<strong>相册</strong></span><span style="font-size:14px; font-family:'微软雅黑'; margin-left:5px; color:#666666">—分类管理</span>				</td>
				<td align="right">
					...
					<tr>
						<td >
							<table align="center">
								...
								<tr>
									<td width="600px" class="myn" style="cursor:pointer"><u>我的照片</u></td>
									<td width="50px" class="myg"><a href="javascript:void(0)" onClick="showDiv('我的照片')">改名</a></td>
								...
								<tr>
									<td width="600px" class="myn" style="cursor:pointer"><u>朋友照片</u></td>
									<td width="50px" class="myg"><a href="javascript:void(0)" onClick="showDiv('朋友照片')">改名</a></td>
									<td width="50px" class="myg"><a href="#" onClick="return confirm('是否删除该分类？')" >删除</a></td>
								</tr>
								...
								<tr>
									<td width="600px" class="myn" style="cursor:pointer"><u>风景</u></td>
									<td width="50px" class="myg"><a href="javascript:void(0)" onClick="showDiv('风景')">改名</a></td>
									<td width="50px" class="myg"><a href="#" onClick="return confirm('是否删除该分类？')" >删除</a></td>
								</tr>
								...
								<tr>
									<td width="600px" class="myn" style="cursor:pointer"><u>美食</u></td>
									<td width="50px" class="myg"><a href="javascript:void(0)" onClick="showDiv('美食')">改名</a></td>
									<td width="50px" class="myg"><a href="#" onClick="return confirm('是否删除该分类？')" >删除</a></td>
								</tr>
