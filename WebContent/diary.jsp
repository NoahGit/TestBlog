	...
	<div id="PageBody">
		...
		<div id="MainBody">
		  <div id="leftInfo" style="text-align:left">
			<h3>当前分类：个人日记</h3>
			<h2><u>${diaryTitle }</u>    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<span style="font-size:12px; font-weight:lighter">日期：${diaryPublishTime }</span></h2>
			<div class="content">
			                    <p> 
			      ${diaryContent }              
			     ...
			     <!--                
			                    ...
			                    如果我们放弃注视和关心周围的人，永远没有公平和正义的一天，谁也不会自由。<br/><br/>“公开化是公民面对专制的利器，仅有的利器。”<br/><br/>“任何一个人，如果不为正义而战，不为所谓的公平而战，他就是非正义和不公正的一部份，这毫无疑问。”<br/><br/>“我每秒钟都受到威胁，因为我生活在一个非常危险性的国度里。”<br/><br/>“为法西斯卖力的人死得比鸿毛还轻。这是法西斯他爹说的。”<br/><br/>
